...
export default function Cursor(){ 
  ...
  return (
    <div ref={ref} className="pointer-events-none fixed z-[9999] inset-0" style={{mixBlendMode:'screen', opacity:0, transition:'opacity 220ms linear'}}>
      ...
      <div className="pointer-events-none fixed rounded-full" style={{width:10,height:10,border:'2px solid rgba(255,255,255,0.9)',transform:'translate3d(-9999px,-9999px,0)'}} />
    </div>
  );
}
